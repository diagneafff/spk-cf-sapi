...
<head>
  ...
  <base href="http://localhost/sapii/">
  ...
  <link rel="shortcut icon" href="cattle.ico" type="image/x-icon">
  <!-- jQuery 2.1.4 -->
...
<body id="pakarsapi" class="hold-transition skin-purple-light sidebar-mini">
  <div class="wrapper">
    <!-- Main Header -->
    <header class="main-header">
      ...
      <a href="./" class="logo">
        ...
        <span class="logo-lg"><b><i class="fa fa-contao" aria-hidden="true"></i>Cattle 2.0</b></span>
      </a>
      <!-- Header Navbar -->
      <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      ...
                      <small>Pakar dari Cattle 2.0</small>
                    </p>
                  </li>
                  <!-- Menu Body -->
                  <li class="user-body">
            ...
            <?php } else { ?>
              <!-- <li><a <?php if ($module == "bantuan") echo 'class="active"'; ?> id="bantu" href="bantuan" data-toggle="tooltip" data-placement="bottom" data-delay='{"show":"300", "hide":"500"}' title="Silahkan klik link berikut, jika anda masih kurang paham tentang penggunaan aplikasi ini !"><i class="fa fa-question-circle"></i> <span>Bantuan</span></a></li> -->
